...
BAKED_BASE="/comfyui/models"

echo ""
echo "  [Z-Image — image generation (from Network Volume)]"
...
echo ""
echo "  [WAN 2.2 I2V — video generation (from Docker Image)]"
...
check_model "LoRA High"   "$BAKED_BASE/loras/Wan_2_2_I2V_A14B_HIGH_lightx2v_4step_lora_v1030_rank_64_bf16.safetensors"
check_model "LoRA Low"    "$BAKED_BASE/loras/Wan2.2-Lightning_I2V-A14B-4steps-lora_LOW_fp16.safetensors"
